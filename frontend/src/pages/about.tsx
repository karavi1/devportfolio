          ...
          <div className="grid gap-10 lg:grid-cols-[1.2fr,0.8fr] items-start">
            <div className="space-y-6">
              <div className="space-y-4 text-lg leading-relaxed text-slate-700">
                ...
                <p>
                  Since Amazon, I have been volunteering, consulting and
                  learning how education currently functions in our society. Along the way, I continued to build full-stack products focused on
                  learning, reflection, and knowledge management. I’m intentionally seeking opportunities to empower educators and students
                  with technology, since I strongly believe that education is the backbone of society.
                </p>
              </div>
