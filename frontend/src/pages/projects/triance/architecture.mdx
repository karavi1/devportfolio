...
export const meta = {
  ...
  // subtitle: 'System context, data model, hot paths, and minimal deployment',
}
...
`} />
      ...
      <div className="text-sm mt-2">
        Tip: add a DB unique constraint on <code>(logged_exercise_id, set_number)</code> to enforce set ordering per exercise.
      </div>
